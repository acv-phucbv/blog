@extends('layouts.default', [
    ...
    'breadcrumbs' => [
        ...
        ['text' => trans("common.user.user_edit")]
    ]
])
...
@section('content')
    ...
    {!! Form::open(['route' => ['users.update', $user->id], 'method' => 'PUT', 'role' => 'form']) !!}
    <div class="page-title">
        <h2>{{ trans('common.user.user_edit') }}</h2>
    </div>
    ...
    <div class="row">
        <div class="col-sm-6 col-xs-12">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    <label for="role">{{ trans('common.user.role') }}&nbsp;<span class="required" aria-required="true">*</span></label>
                    {{ Form::select('role', \App\Models\User::roles(), $user->role, ['class' => 'form-control', 'id' => 'role']) }}
                </div>
            </div>
        </div>
        <div class="col-sm-6 col-xs-12">
            <div class="row">
                <div class="col-xs-12 form-group">
                    <label for="password">{{ trans('common.user.password') }}&nbsp;<span class="required" aria-required="true">*</span></label>
                    {{ Form::input('password', 'password', null, ['class' => 'form-control']) }}
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12 form-group">
                    <label for="password_confirmation">{{ trans('common.user.password_confirmation') }}&nbsp;<span class="required" aria-required="true">*</span></label>
